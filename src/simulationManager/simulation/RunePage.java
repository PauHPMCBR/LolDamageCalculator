...
public class RunePage {
    ...
    public final Rune[] primarySlots = new Rune[3];
    ...
    boolean add(Rune r) {
        if (r.path == RunePath.shards) {
            ...
            if (keystone == null && r.path == primary) keystone = r;
            else {
            ...
            if (r.path == primary) {
                if (primarySlots[r.row] != null) System.out.println("Overriting " + primarySlots[r.row].name);
                primarySlots[r.row] = r;
            }
    ...
    public RunePage(RunePage i) {
        if (i == null) {
            ...
            this.keystone = i.keystone.makeCopy();
